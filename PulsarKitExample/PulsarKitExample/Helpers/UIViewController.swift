...
extension CollectionSourceViewController {
    func populateWithUsers() {
        source.sections.add(element: SourceSection(headerModel: Header(title: "Section 1")))
        ...
        source.sections.add(element: SourceSection(headerModel: Header(title: "Section 2")))
        source.add(model: User(id: 7, name: "John 7"))
        
        source.sections.add(element: SourceSection(headerModel: Header(title: "Section 3")))
